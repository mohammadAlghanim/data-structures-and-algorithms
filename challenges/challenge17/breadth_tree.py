...
def  breadth_first(tree):
     """
    Perform breadth-first traversal on a binary tree and return a list of values in the order they were visited.
    
    Args:
        tree: The binary tree to traverse.
        
    Returns:
        A list of values in the tree visited in breadth-first order.
     """
